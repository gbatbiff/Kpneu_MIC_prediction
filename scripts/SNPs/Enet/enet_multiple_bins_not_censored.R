...
#  set.seed(1234)
  ...
  if (n==2){
    ...
    #colnames(coef_df_summary)<-"coef_importance"
    ...
    write.table(coef_df_summary,sprintf("%s_summary_coef_ACC_enet_bins_%s_not_censored.txt",phen_file,n),
                sep = '\t',quote = F,col.names=NA)
  ...
  if (n==4){
    ...
    coef_elnet_1<-coef_elnet[[1]]
    coef_elnet_2<-coef_elnet[[2]]
    coef_elnet_3<-coef_elnet[[3]]
    coef_elnet_4<-coef_elnet[[4]]
    
    coef1_df <- data.frame(
      features = coef_elnet_1@Dimnames[[1]][ which(coef_elnet_1 != 0 ) ], #intercept included
      coefs    = coef_elnet_1 [ which(coef_elnet_1 != 0 ) ]  #intercept included
    )
    
    ###
    
    coef2_df <- data.frame(
      features = coef_elnet_2@Dimnames[[1]][ which(coef_elnet_2 != 0 ) ], #intercept included
      coefs    = coef_elnet_2 [ which(coef_elnet_2 != 0 ) ]  #intercept included
    )
    ...
    coef3_df <- data.frame(
      features = coef_elnet_3@Dimnames[[1]][ which(coef_elnet_3 != 0 ) ], #intercept included
      coefs    = coef_elnet_3 [ which(coef_elnet_3 != 0 ) ]  #intercept included
    )
    ...
    coef4_df <- data.frame(
      features = coef_elnet_4@Dimnames[[1]][ which(coef_elnet_4 != 0 ) ], #intercept included
      coefs    = coef_elnet_4 [ which(coef_elnet_4 != 0 ) ]  #intercept included
    )
    
    coef_df_summary<-rbind(coef1_df,coef2_df,coef3_df,coef4_df)
  ...
  if (n==6){
    ...
    coef_elnet_3<-coef_elnet[[3]]
    coef_elnet_4<-coef_elnet[[4]]
    coef_elnet_5<-coef_elnet[[5]]
    coef_elnet_6<-coef_elnet[[6]]
    ...
    coef3_df <- data.frame(
      features = coef_elnet_3@Dimnames[[1]][ which(coef_elnet_3 != 0 ) ],
      coefs    = coef_elnet_3 [ which(coef_elnet_3 != 0 ) ]  
    )
    
    
    coef4_df <- data.frame(
      features = coef_elnet_4@Dimnames[[1]][ which(coef_elnet_4 != 0 ) ], 
      coefs    = coef_elnet_4 [ which(coef_elnet_4 != 0 ) ]  
    )
    
    coef5_df <- data.frame(
      features = coef_elnet_5@Dimnames[[1]][ which(coef_elnet_5 != 0 ) ], 
      coefs    = coef_elnet_5 [ which(coef_elnet_5 != 0 ) ]  
    )
    
    coef6_df <- data.frame(
      features = coef_elnet_6@Dimnames[[1]][ which(coef_elnet_6 != 0 ) ], 
      coefs    = coef_elnet_6 [ which(coef_elnet_6 != 0 ) ] 
    )
    
    
    coef_df_summary<-rbind(coef1_df,coef2_df,coef3_df,coef4_df,coef5_df,coef6_df)
